...
# ---------------------------------------------------------------------------
# Samples (Generate stage) — v3 format
# ---------------------------------------------------------------------------

class Sample(BaseModel):
    """A generated training sample with full lineage.

    The ``content`` dict uses the v3 reasoning format::
    ...
    Other formats (instruction, agent, coding, chat) have their own
    content schema — see ``stages/generate/formats/``.
    """
